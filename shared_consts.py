...
LEGAL_ATTRS = {BEACONS: [BEACON_TYPE, ID, IS_ACTIVE, MAJOR, MINOR, RETAILER_ID],
               ...
               OFFERS: [KMEANS_CATEGORY_ID, DESCRIPTION, IAB_CATEGORY_ID, ID, IMAGE_FILENAMES, NAME, PRODUCT_IDS,
                        QUANTITY_PER_CONSUMER, QUANTITY_TOTAL, RETAILER_ID, SURVEY_IMAGE_URL, STARTS_AT, STOPS_AT,
...
MANDATORY_ATTRS = {BEACONS: [BEACON_TYPE, ID, IS_ACTIVE, MAJOR, MINOR, RETAILER_ID],
                   BLACKLIST_TOKENS: [],
                   CALENDAR_EVENTS: [CONSUMER_ID, IAB_CATEGORY_ID, ID, NAME, OCCURS_AT],
                   BEACON_INTERACTIONS: [BEACON_ID, CONSUMER_ID, DURATION, ID, RETAILER_ID, OCCURRED_AT],
                   OFFER_INTERACTIONS: [CONSUMER_ID, ID, INTERACTION_TYPE, OCCURRED_AT, OFFER_ID, RETAILER_ID,
                                        SENTIMENT],
                   PRODUCT_INTERACTIONS: [CONSUMER_ID, ID, INTERACTION_TYPE, OCCURRED_AT, PRODUCT_ID, RETAILER_ID,
                                          SENTIMENT],
                   RETAILER_INTERACTIONS: [CONSUMER_ID, ID, INTERACTION_TYPE, OCCURRED_AT, RETAILER_ID, SENTIMENT],
                   THIRD_PARTY_INTERACTIONS: [CONSUMER_ID, IAB_CATEGORY_ID, ID, SENTIMENT, THIRD_PARTY_NAME],
                   CONSUMERS: [ID],
                   IAB_CATEGORIES: [ID, NAME],
                   PRODUCTS: [ID, IS_FILE_UPLOAD, NAME, PRICE, RETAILER_ID],
                   OFFERS: [ID, NAME, PRODUCT_IDS, RETAILER_ID],
                   RATINGS: [CONSUMER_ID, ID, IS_PREDICTION, ITEM_ID, ITEM_TYPE, NAME, PRICE, RETAILER_ID,
                             RETAILER_NAME, SENTIMENT],
                   RETAILER_USERS: [ID, IS_ADMIN, RETAILER_ID, USERNAME],
                   RETAILERS: [ID, LAT, LONG, NAME],
                   TOWN_USERS: [ID, USERNAME]}
